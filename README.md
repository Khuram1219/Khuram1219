...
I'm a **Generative AI Engineer** and **Conversational AI Developer** specializing in the design and development of intelligent, scalable, and highly contextual AI chatbot systems.
...
- GPT-4, GPT-3.5, Claude, LLaMA, Gemini, Deepseek, LangChain
- Fine-tuned prompts, multi-turn memory, context management
...
- FastAPI, Flask, Express.js, LangChain, OpenAI SDK
- Gradio, Streamlit for rapid prototyping

**Databases & Cloud**
- PostgreSQL, MongoDB, Firebase, Redis, Supabase
- Pinecone, Chroma, Qdrant for vector search
- AWS (EC2, S3, Lambda), Vercel, Docker, NGINX, PM2
...
- ✦ A chatbot for Study
- ✦ AI-Powered Video Editing Chatbot
- ✦ Experience Management Software Bot
- ✦ AI-Driven Tax Aid Assistant
